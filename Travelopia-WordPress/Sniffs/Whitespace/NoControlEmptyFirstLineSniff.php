 ...
 */
class NoControlEmptyFirstLineSniff implements Sniff {
	...
	public function register(): array {
		return [ T_IF, T_ELSE, T_ELSEIF, T_FOR, T_FOREACH ];
	}
	...
	public function process( File $phpcsFile, $stackPtr ): void {
		...
		if ( "\n" === $tokens[ $open_bracket + 1 ]['content'] && "\n" === $tokens[ $open_bracket + 2 ]['content'] ) {
			$phpcsFile->addWarningOnLine(
				'First line of a control structure must not be empty.',
